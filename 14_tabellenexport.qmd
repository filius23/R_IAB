...
Dazges1u erstellen wir eine Funktion erstellen, welche bspw. mit `gsub()`  Variablennamen durch die gewünschte Beschriftung ersetzt:
```{r}
...
+ Erstellen Sie eine Übersichtstabelle zu `gkpol` (Größe der Wohngemeinde) und `schul2_fct` (Ausbildung).
