...
[Markdown](https://daringfireball.net/projects/markdown/) ist eine vereinfachte Auszeichnungssprache, die Textformatierung mit einfachen Befehlen erlaubt.
RMarkdown nutzt [pandoc](https://pandoc.org/), um Markdown-Dokumente in verschiedene Formate umzuwandeln: HTML, PDF, Word, PowerPoint, ...
...
<tbody>
<tr class="odd">
<td><pre>Etwas Text in einem Absatz.<br>
Mehr Text in einem neuem Absatz. Absätze werden durch Leerzeilen getrennt</pre></td>
<td></td>
<td><p>Etwas Text in einem Absatz.</p>
